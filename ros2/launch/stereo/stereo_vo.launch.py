...
def generate_launch_description():
  ...
  stereo_vo_node = Node(
    ...
    output='screen',
    parameters=[
        {'topicname_image_left': '/stereo_camera/left/image_raw'},
        {'topicname_image_right': '/stereo_camera/right/image_raw'},
        ...
        {'directory_intrinsic': '/home/kch/ros2_ws/src/visual_odometry_ros/config/stereo/exp_stereo2.yaml'}
    ]
    # parameters = [config]
  )
