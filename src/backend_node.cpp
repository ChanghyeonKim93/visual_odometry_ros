 ...
 * @date 10-July-2022
 */
BackendNode::BackendNode(ros::NodeHandle& nh) : nh_(nh) 
{
    // Get user pamareters
    this->getParameters();
    ...
    // Subscriber    
    // img_sub_ = nh_.subscribe<sensor_msgs::Image>(topicname_image_, 1, &BackendNode::imageCallback, this);
    img_sub_ = nh_.subscribe<sensor_msgs::Image>("/scale_mono_vo/external_vo/image", 1, &BackendNode::imageCallback, this);
 ...
 * @date 10-July-2022
 */
void BackendNode::imageCallback(const sensor_msgs::ImageConstPtr& msg) {
...
void BackendNode::poseCallback(const geometry_msgs::PoseStampedConstPtr& msg)
{
